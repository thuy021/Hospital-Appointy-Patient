                            ...
                            if(i>30)
                            {
                                ...
                                mPatientDatabase.child("Doctor_Details").child(getIntent().getStringExtra("DoctorUserId")).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        intent.putExtra(CalendarContract.Events.TITLE,"You have an appointment with doctor " + doctorName +" at " +time );
                                        intent.putExtra(CalendarContract.Events.EVENT_LOCATION,"Hospital");
                                        intent.putExtra(CalendarContract.Events.DESCRIPTION,"Go to hospital soon");
                                        ...
                                        calendarEnd.set(year,month,day,h,m+20,s);
                                            ...
                                            public void run() {
                                                try{
                                                    GMailSender sender = new GMailSender("phanbach.iuh@gmail.com",
                                                            "Phanbach3007");
                                                    sender.sendMail("Booked Appointment", "You have a new appointment with Patient At " + time + date + " Please check your appointment schedule on APP",
                                                            "phanbach19@gmail.com", email);
                                                }catch (Exception e){
...
/*                Intent intent = new Intent(Patient_BookAppointmentActivity.this,Patient_BookAppointmentActivity.class);
