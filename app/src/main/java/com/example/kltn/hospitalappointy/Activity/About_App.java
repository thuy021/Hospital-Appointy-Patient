...
//        setContentView(R.layout.activity_about_app);
        ...
        View aboutPage = new AboutPage(this)
                ...
                .addEmail("phanbach19@gmail.com")
                .addEmail("thanhthuyjp8@gmail.com")
                .addWebsite("http://hospittal_appoinity.com")
                .addFacebook("https://www.facebook.com/phanbach99")
                .addTwitter("")
                .addInstagram("")
                .addGitHub("PhanBach19/Hospital-Appointy-Web")
